...
def run():
	os.system(f"gst-launch-1.0 v4l2src device='/dev/video0' ! videoflip method=vertical-flip ! video/x-raw,width={video_width},height={video_height},framerate=15/1 ! jpegenc ! rtpjpegpay ! udpsink host={host} port={port}")  
